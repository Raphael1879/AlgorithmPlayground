...
var originalData = Enumerable.Range(1, 10000).Reverse().ToArray(); //worst case for quickSort. introSort should switch to heap sort
...
Console.WriteLine($"Intro Sort time: {sw1.ElapsedMilliseconds} ms");
...
Console.WriteLine($"QuickSort time: {sw2.ElapsedMilliseconds} ms");
